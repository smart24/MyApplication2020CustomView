...
/**
 * FileName: PaintDiscretePathEffectView
 *
 * Des: DiscretePathEffect  离散
 *
 * Time: 2020/5/29 3:44 PM
 */
public class PaintDiscretePathEffectView extends View {
    ...
    public PaintDiscretePathEffectView(Context context) {
        this(context, null);
    }

    public PaintDiscretePathEffectView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PaintDiscretePathEffectView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
