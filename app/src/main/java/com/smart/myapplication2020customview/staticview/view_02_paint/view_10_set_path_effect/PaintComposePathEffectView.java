...
/**
 * FileName: PaintComposePathEffectView
 *
 * Des: ComposePathEffect
 *
 * Time: 2020/6/2 2:50 PM
 */
class PaintComposePathEffectView extends View {
    ...
    public PaintComposePathEffectView(Context context) {
        this(context, null);
    }

    public PaintComposePathEffectView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PaintComposePathEffectView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mPathEffect = new ComposePathEffect(dashEffect, discreteEffect);
...
//        mPathEffect = new ComposePathEffect(discreteEffect1, discreteEffect2);
//        mDstPaint.setPathEffect(mPathEffect);
    }
