 ...
 */
public class PaintSetTextEffectView extends View {
    ...
    public PaintSetTextEffectView(Context context) {
        this(context, null);
    }

    public PaintSetTextEffectView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PaintSetTextEffectView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
