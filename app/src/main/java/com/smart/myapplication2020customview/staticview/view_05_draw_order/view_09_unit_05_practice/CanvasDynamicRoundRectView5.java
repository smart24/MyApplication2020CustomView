 ...
 *      3. 画 SubmitButton；✔
 *
 *      4. - 点击时间过短时，按下的动画不完整播放——根据按下的时间长短，执行不同的动画逻辑；👈
 ...
 */
public class CanvasDynamicRoundRectView5 extends View {
    ...
    public CanvasDynamicRoundRectView5(Context context) {
        this(context, null);
    }

    public CanvasDynamicRoundRectView5(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CanvasDynamicRoundRectView5(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
