 ...
 */
public class AliPayBillView extends View {

    private Paint mArcPaint, mIndicatorPointPaint, mIndicatorLinePaint, mTextPaint, mValuePaint;
    private float mArcStrokeWidth, mIndicatorPointRadius, mIndicatorStrokeWidth, mTextFontSize, mValueFontSize;
    ...
    public AliPayBillView(Context context) {
        this(context, null);
    }

    public AliPayBillView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AliPayBillView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//                                false,
//                                mItemColors[i],
//                                (float) ((mRadius + mIndicatorPadding * 2) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding * 2) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding * 2 + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding * 2 + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding * 2 + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding * 2 + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding * 2 + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) + (Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) >= 0 ? 1 : -1) * mIndicatorExtendedLineLength),
//                                (float) ((mRadius + mIndicatorPadding * 2 + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding * 2 + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) + (Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) >= 0 ? 1 : -1) * (mIndicatorExtendedLineLength + mIndicatorPadding + (Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) >= 0 ? 0 : rect.width()))),
//                                (float) ((mRadius + mIndicatorPadding * 2 + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) + rect.height()/3)
//                        )
//                );
//            } else {
//                mItems.add(
...
//                                false,
//                                mItemColors[i],
//                                (float) ((mRadius + mIndicatorPadding) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) + (Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) >= 0 ? 1 : -1) * mIndicatorExtendedLineLength),
//                                (float) ((mRadius + mIndicatorPadding + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                                (float) ((mRadius + mIndicatorPadding + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) + (Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) >= 0 ? 1 : -1) * (mIndicatorExtendedLineLength + mIndicatorPadding + (Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) >= 0 ? 0 : rect.width()))),
//                                (float) ((mRadius + mIndicatorPadding + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) + rect.height()/3)
//                        )
//                );
//            }
...
//                            false,
//                            mItemColors[i],
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) + (Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) >= 0 ? 1 : -1) * mIndicatorExtendedLineLength),
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2))),
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding + mIndicatorLength) * Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) + (Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) >= 0 ? 1 : -1) * (mIndicatorExtendedLineLength + mIndicatorPadding + mArcStrokeWidth/2 + (Math.cos(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) >= 0 ? 0 : rect.width()))),
//                            (float) ((mRadius + mArcStrokeWidth + mIndicatorPadding + mIndicatorLength) * Math.sin(Math.toRadians(startAngle + 360 * mItemPercentages[i] / 2)) + rect.height()/3)
//                    )
//            );
//            startAngle += 360 * mItemPercentages[i] + 360 * mItemSpace;
//        }
...
//            mValuePaint.setColor(item.getColor());
