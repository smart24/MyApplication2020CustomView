 ...
 */
public class CanvasDynamicRoundRectView3 extends View implements View.OnClickListener {
    ...
    public CanvasDynamicRoundRectView3(Context context) {
        this(context, null);
    }

    public CanvasDynamicRoundRectView3(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CanvasDynamicRoundRectView3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAnimator(){
        if(mRectColorAnimator == null){
            ...
            mRectColorAnimator.setDuration(getResources().getInteger(R.integer.four_hundred));
        ...
        if(mRectFrameColorAnimator == null){
            ...
            mRectFrameColorAnimator.setDuration(getResources().getInteger(R.integer.four_hundred));
        ...
        if(mAnimatorSet == null){
            ...
            mAnimatorSet.playTogether(mRectColorAnimator, mRectFrameColorAnimator, mValueAnimator);
            mAnimatorSet.start();
